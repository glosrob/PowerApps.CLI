...
public class ConstantsFilter : IConstantsFilter
{
    ...
    private List<AttributeSchema> FilterAttributeList(List<AttributeSchema> attributes, ConstantsConfig config)
    {
        ...
        //   Money + read-only: base-currency companion fields (e.g. xrt_amount_base). AttributeOf is not
        //     reliably populated for these by the SDK, so we detect them via IsValidForCreate/Update both false.
